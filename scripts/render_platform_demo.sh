...
# These are real browser stills. Preserve the whole viewport and its aspect ratio.
# The gentle camera move is an edit, not a claim about application animation.
shot="scale=2560:1440:force_original_aspect_ratio=decrease:out_range=tv,pad=2560:1440:(ow-iw)/2:(oh-ih)/2:color=0xf6f4ed"
shot+=",zoompan=z='1+0.0001*on':x='iw/2-iw/zoom/2':y='ih/2-ih/zoom/2':d=100:s=1280x720:fps=30,setsar=1"
...
ffmpeg -y -loglevel error \
  ...
  -i "$capture_directory/03-evidence.png" \
