...
Typography starts from Helvetica Neue for data, dates, controls, and source text. [Bricolage Grotesque](https://github.com/ateliertriay/bricolage), self-hosted under its bundled Open Font License, adds a restrained playful accent to the masthead and page title only. The evidence panels keep plain sans serif text.

In the local browser trial, the Postgres-backed dashboard rendered at 1280px and 390px without horizontal overflow. A direct record URL, a new selection, and browser back kept the marked route in sync with the evidence. The capture-details disclosure opened from the keyboard. These observations support this implementation; they do not establish a general design rule.
